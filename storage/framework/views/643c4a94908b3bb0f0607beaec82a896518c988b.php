       ...
       <div class="col-md-12">
        ...
        <div class="col-md-2 left">
          ...
          <div class="col-md-4 left">
              <input type="hidden" class="custom-select small" id="empid" name="idnumber" value="<?php echo e($select->id_number); ?>">
              <input type="text" disabled value="<?php echo e($select->first_name); ?> <?php echo e($select->middle_name); ?> <?php echo e($select->surname); ?>">
              </select>
          </div>
           <br> <br>
       </div>
        ...
        <div class="col-sm-8 right">
          ...
          <button class="btn btn-info btngreen" type="submit" value="Submit">
            ...
            <div class="col-md-12 rowm"> 
                ...
                <input type="hidden" class="form-control small" name="emp_id" id="emp_id" value="<?php echo e($select->id_number); ?>">
            </div>
  </div>
</div>
...
<div class="row rowm small">
    ...
    <div class="col-md-3 small">
      ...
      <div>
        <input type="text" class="form-control small" name="basic" id="num8">
      </div>
    </div>

    <div class="col-md-3">
      <label><p class="small">Allowance(peso)</p></label>
      <input type="text" class="form-control small" name="allowance" id="num9">
    </div>

    <div class="col-md-3">
      <label><p class="small">Rendered Hours</p></label>
      <input type="text" class="form-control small" name="renderedhours" id="rendered" >
    </div>

    <div class="col-md-3">
      <label><p class="small">Required Hours(hrs)</p></label>
      <input type="text" class="form-control small" value="96" name="requiredhours" id="num10">
    </div>
...
<div class="row rowm">
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control small" name="overtime" id="num1">
    </div>

    <div class="col-md-3">
      <label><p class="small">Non-Working Holiday(days)</p></label>
      <input type="text" class="form-control small" name="nonholiday" id="num2" readonly value="0">
    </div>

    <div class="col-md-3">
      <label><p class="small">Regular Holiday(days)</p></label>
      <input type="text" class="form-control small" name="regular" id="num15" readonly value="0">
    </div>
   ...
   <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          ...
          <input type="text" class="form-control small" name="gross" placeholder="total gross" id="gross" readonly>
        </div>
   </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control small" name="undertime" id="num5">
  </div>

  <div class="col-md-3">
    <label><p class="small">Late(mins)</p></label>
    <input type="text" class="form-control small" name="late" id="num6">
  </div>

  <div class="col-md-3">
    <label><p class="small">Absent(days)</p></label>
    <input type="text" class="form-control small" name="absent" id="num7" >
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control small" name="sss" id="num11">
  </div>

  <div class="col-md-3">
    <label><p class="small">HDMF(peso)</p></label>
    <input type="text" class="form-control small" name="hdmf" id="num12">
  </div>

  <div class="col-md-3">
    <label><p class="small"> Philhealth(peso)</p></label>
    <input type="text" class="form-control small" name="philhealth" id="num13">
  </div>

  <div class="col-md-3">
    <label><p class="small">Holding Tax</p></label>
    <input type="text" class="form-control small" name="holdingtax" id="num14">
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          ...
          <input type="text" class="form-control small" name="government_deduction" placeholder="total deduction" id="deduction" readonly>
          <label><p class="small">Net Pay</p></label>
          <input type="text" class="form-control small" name="netpay"placeholder="total" id="netpay" readonly>
        </div>
   </div>   
...
<script type="text/javascript">
  function formatDate(date) {
   ...
   $(document).ready(function () {
    ...
    $("#num1, #num2, #num3, #num4, #num5, #num6, #num7, #num8, #num9, #num10, #rendered, #num11, #num12, #num13, #num14, #num15, #otherdeduct, #otherearn").on("keydown keyup", function() {
        sum();
    });
...
function sum() {
    ...
    // formula pag gagawing auto compute yung sss at iba pa
