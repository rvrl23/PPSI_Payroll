...
<form action="" method="payroll" id="payrollform">

 <div>
  <p class="page-label monsterrat xx-large"><span class="glyphicon glyphicon-tasks"></span> Edit Payroll</p>
</div>
       ...
       <div class="col-md-12">
        ...
        <div class="col-md-2 left">
                ...
                <div class="col-md-4 left">
                      ...
                      <option value="<?php echo e($joinn->id_number); ?>"><?php echo e($joinn->first_name); ?> <?php echo e($joinn->middle_name); ?> <?php echo e($joinn->surname); ?></option>
                    </select>
        ...
        <div class="col-md-2">
                ...
                <select class="custom-select small" name="cut_off" id="cut_off">
                  <option><?php echo e($joinn->cut_off); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-01-15">January 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-01-30">January 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-02-15">February 1-15 <?php echo e(date('Y')); ?></option>

                  <?php if((date('Y')%4)==0): ?>)

                  <option value="<?php echo e(date('Y')); ?>-02-29">February 16-29 <?php echo e(date('Y')); ?></option>

                  <?php else: ?>

                  <option value="<?php echo e(date('Y')); ?>-02-28">February 16-28 <?php echo e(date('Y')); ?></option>

                  <?php endif; ?>

                  <option value="<?php echo e(date('Y')); ?>-03-15">March 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-03-30">March 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-04-15">April 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-04-30">April 16-30 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-05-15">May 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-05-30">May 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-06-15">June 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-06-30">June 16-30 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-07-15">July 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-07-30">July 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-08-15">August 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-08-30">August 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-09-15">September 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-09-30">September 16-30 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-10-15">October 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-10-30">October 16-31 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-11-15">November 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-11-30">November 16-30 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-12-15">December 1-15 <?php echo e(date('Y')); ?></option>
                  <option value="<?php echo e(date('Y')); ?>-12-30">December 16-31 <?php echo e(date('Y')); ?></option>
                </select>
            </div>
            <input type="hidden" value="<?php echo e($joinn->cut_off); ?>" id="hidden_cut">

        <div class="col-sm-8 right">

          <a href ='<?php echo e(url('payroll')); ?>' class ="btn btn-danger btnd">
          ...
          <button type="button" class ="btn btn-primary btnd" id="btnsaveas">
          <span class="glyphicon glyphicon-arrow-left small"></span> Save as new Payroll</button>
        </div>
...
<div class="row rowm small">
    ...
    <div class="col-md-3 small">
      ...
      <div>
        <input required type="text" class="form-control small" name="basic" id="num8" value="<?php echo e($joinn->basic); ?>">
      </div>
    </div>

    <div class="col-md-3">
      <label><p class="small">Allowance(peso)</p></label>
      <input required type="text" class="form-control small" name="allowance" id="num9" value="<?php echo e($joinn->allowance); ?>">
    </div>

    <div class="col-md-3">
      <label><p class="small">Rendered Hours</p></label>
      <input required type="text" class="form-control small" name="renderedhours" id="rendered" value="<?php echo e($joinn->renderedhours); ?>">
    </div>

    <div class="col-md-3">
      <label><p class="small">Required Hours(hrs)</p></label>
      <input required type="text" class="form-control small" value="96" name="requiredhours" value="<?php echo e($joinn->allowance); ?>" id="num10" readonly>
    </div>
...
<div class="row rowm">
    ...
    <div class="col-md-3">
      ...
      <input required type="text" class="form-control small" name="overtime" value="<?php echo e($joinn->overtime); ?>" id="num1">
    </div>

    <div class="col-md-3">
      <label><p class="small">Non-Working Holiday(days)</p></label>
      <input required type="text" class="form-control small" name="nonholiday" value="<?php echo e($joinn->nworking_holiday); ?>" id="num2">
    </div>

    <div class="col-md-3">
      <label><p class="small">Regular Holiday(days)</p></label>
      <input required type="text" class="form-control small" name="regular" value="<?php echo e($joinn->regular_holiday); ?>" id="num15">
<input required type="hidden" class="form-control small" name="idnumber"id="emp_id" value="<?php echo e($joinn->idnumber); ?>">
    </div>
    ...
    <div class="col-md-3">
      ...
      <input required type="text" class="form-control small" name="otherearn" id="otherearn" value="<?php echo e($joinn->otherearnings); ?>">
    </div>


   <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          <label><p class="small">Gross Pay(peso)</p></label>
          <input required type="text" class="form-control small" name="gross" placeholder="total gross" id="gross" value="<?php echo e($joinn->gross); ?>" readonly>
        </div>
   </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input required type="text" class="form-control small" name="undertime" value="<?php echo e($joinn->undertime); ?>" id="num5">
  </div>

  <div class="col-md-3">
    <label><p class="small">Late(mins)</p></label>
    <input required type="text" class="form-control small" name="late" value="<?php echo e($joinn->late); ?>" id="num6">
  </div>

  <div class="col-md-3">
    <label><p class="small">Absent(days)</p></label>
    <input required type="text" class="form-control small" name="absent" value="<?php echo e($joinn->absent); ?>" id="num7" >
  </div>

  <div class="col-md-3">
    <label><p class="small">Other Deduction</p></label>
    <input required type="text" class="form-control small" name="otherdeduct" id="otherdeduct" value="<?php echo e($joinn->otherdeduction); ?>" >
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input required type="text" class="form-control small" name="sss" id="num11" value="<?php echo e($joinn->sss); ?>">
  </div>

  <div class="col-md-3">
    <label><p class="small">HDMF(peso)</p></label>
    <input required type="text" class="form-control small" name="hdmf" id="num12" value="<?php echo e($joinn->hdmf); ?>">
  </div>

  <div class="col-md-3">
    <label><p class="small"> Philhealth(peso)</p></label>
    <input required type="text" class="form-control small" name="philhealth" id="num13" value="<?php echo e($joinn->philhealth); ?>">
  </div>

  <div class="col-md-3">
    <label><p class="small">Holding Tax</p></label>
    <input required type="text" class="form-control small" name="holdingtax" id="num14" value="<?php echo e($joinn->holdingtax); ?>">
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          <label><p class="small">Gross Deduction</p></label>
          <input required type="text" class="form-control small" name="deduction" placeholder="total deduction" id="deduction" value="<?php echo e($joinn->deduction); ?>" readonly>
          <label><p class="small">Net Pay</p></label>
          <input required type="text" class="form-control small" name="netpay"placeholder="total" id="netpay" value="<?php echo e($joinn->netpay); ?>" readonly>
        </div>
   </div>   
...
<script type="text/javascript">
   $(document).ready(function () {
     ...
     $('#btnsave').on('click', function(){
      var hidden_cut = document.getElementById('hidden_cut').value;
       document.getElementById("pid").value = '';
         ...
         var cut = document.getElementById("cut_off").value;
          ...
          if(hidden_cut == cut)
          {
            $("#payrollform").attr("action", "/updatepay/" + <?php echo e($joinn->pid); ?>);
            $('#payrollform').submit();
          }
          else if(check != ""){
            alert('duplicate cut_off' + check);
    ...
    $('#btnsaveas').on('click', function(){
       ...
       var cut = document.getElementById("cut_off").value;
        ...
        if(check != ""){
          ...
          $("#payrollform").attr("action", "/addasnew/");
          $('#payrollform').submit();
        }
       })
    ...
    $("#num1, #num2, #num5, #num6, #num7, #num8, #num9, #num10, #rendered, #num11, #num12, #num13, #num14, #num15, #otherdeduct, #otherearn").on("keydown keyup", function() {
        sum();
    });
