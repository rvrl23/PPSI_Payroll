		...
		<table id="EmployeeTable" class="table">
		    ...
		    <tbody>
		      ...
		      <tr>
				...
				<a href="deleteEmployee/<?php echo e($employee->id); ?>" class="btn btn-danger btn-circle inline-block"><span class="glyphicon glyphicon-trash"></span>  </a>
		    ...
		    <tbody>
		      ...
		      <tr>
		        ...
		        <td colspan="1"> 
	            	...
	            	<a href="restorePayroll/<?php echo e($pay->id); ?>" class="btn btn-primary inline-block btn-circle"><span class="glyphicon glyphicon-refresh"></span>  </a>
		          
		            <a href="deletePayroll/<?php echo e($pay->id); ?>" class="btn btn-danger inline-block"><span class="glyphicon glyphicon-refresh"></span>  </a>
