       ...
       <div class="col-md-12">
        ...
        <div class="col-md-2 left">
                ...
                <div class="col-md-4 left">
                      ...
                      <option value="{{$joinn->id_number}}">{{$joinn->first_name}} {{$joinn->middle_name}} {{$joinn->surname}}</option>
                    </select>
        ...
        <div class="col-md-2">
            ...
            <input type="hidden" value="{{$joinn->cut_off}}" id="hidden_cut">
...
<div class="row rowm small">
    ...
    <div class="col-md-3 small">
      ...
      <div>
        <input required type="text" class="form-control small" name="basic" id="num8" value="{{$joinn->basic}}">
      </div>
    </div>

    <div class="col-md-3">
      <label><p class="small">Allowance(peso)</p></label>
      <input required type="text" class="form-control small" name="allowance" id="num9" value="{{$joinn->allowance}}">
    </div>

    <div class="col-md-3">
      <label><p class="small">Rendered Hours</p></label>
      <input required type="text" class="form-control small" name="renderedhours" id="rendered" value="{{$joinn->renderedhours}}">
    </div>

    <div class="col-md-3">
      <label><p class="small">Required Hours(hrs)</p></label>
      <input required type="text" class="form-control small" value="96" name="requiredhours" value="{{$joinn->allowance}}" id="num10" readonly>
    </div>
...
<div class="row rowm">
    ...
    <div class="col-md-3">
      ...
      <input required type="text" class="form-control small" name="overtime" value="{{$joinn->overtime}}" id="num1">
    </div>

    <div class="col-md-3">
      <label><p class="small">Non-Working Holiday(days)</p></label>
      <input required type="text" class="form-control small" name="nonholiday" value="{{$joinn->nworking_holiday}}" id="num2">
    </div>

    <div class="col-md-3">
      <label><p class="small">Regular Holiday(days)</p></label>
      <input required type="text" class="form-control small" name="regular" value="{{$joinn->regular_holiday}}" id="num15">
<input required type="hidden" class="form-control small" name="idnumber"id="emp_id" value="{{$joinn->idnumber}}">
    </div>
    ...
    <div class="col-md-3">
      ...
      <input required type="text" class="form-control small" name="otherearn" id="otherearn" value="{{$joinn->otherearnings}}">
    </div>
   ...
   <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          ...
          <input required type="text" class="form-control small" name="gross" placeholder="total gross" id="gross" value="{{$joinn->gross}}" readonly>
        </div>
   </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input required type="text" class="form-control small" name="undertime" value="{{$joinn->undertime}}" id="num5">
  </div>

  <div class="col-md-3">
    <label><p class="small">Late(mins)</p></label>
    <input required type="text" class="form-control small" name="late" value="{{$joinn->late}}" id="num6">
  </div>

  <div class="col-md-3">
    <label><p class="small">Absent(days)</p></label>
    <input required type="text" class="form-control small" name="absent" value="{{$joinn->absent}}" id="num7" >
  </div>

  <div class="col-md-3">
    <label><p class="small">Other Deduction</p></label>
    <input required type="text" class="form-control small" name="otherdeduct" id="otherdeduct" value="{{$joinn->otherdeduction}}" >
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-3">
    ...
    <input required type="text" class="form-control small" name="sss" id="num11" value="{{$joinn->sss}}">
  </div>

  <div class="col-md-3">
    <label><p class="small">HDMF(peso)</p></label>
    <input required type="text" class="form-control small" name="hdmf" id="num12" value="{{$joinn->hdmf}}">
  </div>

  <div class="col-md-3">
    <label><p class="small"> Philhealth(peso)</p></label>
    <input required type="text" class="form-control small" name="philhealth" id="num13" value="{{$joinn->philhealth}}">
  </div>

  <div class="col-md-3">
    <label><p class="small">Holding Tax</p></label>
    <input required type="text" class="form-control small" name="holdingtax" id="num14" value="{{$joinn->holdingtax}}">
  </div>
...
<div class="row rowm">
  ...
  <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          ...
          <input required type="text" class="form-control small" name="deduction" placeholder="total deduction" id="deduction" value="{{$joinn->deduction}}" readonly>
          <label><p class="small">Net Pay</p></label>
          <input required type="text" class="form-control small" name="netpay"placeholder="total" id="netpay" value="{{$joinn->netpay}}" readonly>
        </div>
   </div>   
      ...
      var hidden_cut = document.getElementById('hidden_cut').value;
       document.getElementById("pid").value = '';
         ...
         var cut = document.getElementById("cut_off").value;
          ...
          if(hidden_cut == cut)
          {
            $("#payrollform").attr("action", "/updatepay/" + {{$joinn->pid}});
            $('#payrollform').submit();
          }
          else if(check != ""){
