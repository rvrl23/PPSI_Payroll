       ...
       <div class="col-md-12">
        ...
        <div class="col-md-2 left">
          ...
          <div class="col-md-4 left">
              <input type="hidden" class="custom-select small" id="empid" name="idnumber" value="{{$select->id_number}}">
              <input type="text" disabled value="{{$select->first_name}} {{$select->middle_name}} {{$select->surname}}">
              </select>
          </div>
           <br> <br>
       </div>
        ...
        <div class="col-sm-8 right">
          ...
          <button class="btn btn-info btngreen" type="submit" value="Submit">
            ...
            <div class="col-md-12 rowm"> 
                ...
                <input type="hidden" class="form-control small" name="emp_id" id="emp_id" value="{{$select->id_number}}">
            </div>
  </div>
</div>
...
{{-- <div class="col-md-12 gross-grid margin-top">
        <div class="gross-grid-item margin-top">
          ...
          <input type="text" class="form-control small" name="ren1" placeholder="Present days" id="ren1" readonly>
        </div>
   </div> --}}
